...
# Define filenames and their associated identifiers
filenames = {
...
def find_asn_overlaps(filenames):
    ...
    # Load ASNs from files and track which identifiers contain each ASN
...
# Restrict identifiers to only Google and Azure
    ...
    # Overlaps across all providers
    all_providers_overlap_asns = set.intersection(*provider_to_asns.values())
    # For each ASN in all_providers_overlap_asns, get the identifiers
...
if __name__ == "__main__":
    ...
    # Save overlaps among all instances
    ...
    # Save overlaps between GCP and Azure
    ...
    # Save overlaps across all providers
